 ...
 * @param {string} typ_source
 * @param {string} files_json
 * @param {string} binary_files_json
 * @returns {Uint8Array}
 */
export function render_to_pdf(typ_source, files_json, binary_files_json) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(typ_source, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(files_json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(binary_files_json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len2 = WASM_VECTOR_LEN;
        wasm.render_to_pdf(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
 ...
 * @returns {string}
 */
export function typst_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.typst_version(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./omd2typst_pdf_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('omd2typst_pdf_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
